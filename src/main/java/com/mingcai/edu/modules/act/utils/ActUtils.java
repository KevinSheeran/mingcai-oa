 ...
 */
package com.mingcai.edu.modules.act.utils;
...
import com.mingcai.edu.common.annotation.FieldName;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_EA = new String[]{"ea", "oa_finance_ea"};
