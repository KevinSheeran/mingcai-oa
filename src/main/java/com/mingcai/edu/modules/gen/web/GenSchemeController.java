 ...
 */
package com.mingcai.edu.modules.gen.web;
...
import com.mingcai.edu.modules.gen.service.GenSchemeService;
import com.mingcai.edu.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.mingcai.edu.modules");
		}
//		if (StringUtils.isBlank(genScheme.getFunctionAuthor())){
//			genScheme.setFunctionAuthor(EAUtils.getUser().getName());
//		}
