 ...
 * @version 2018-01-12
 */
public class OaContractServicesInfo extends DataEntity<OaContractServicesInfo> {
	
	private static final long serialVersionUID = 1L;
	private String name;		// 单位名称
	private String productName;		// 项目名称
	private String contacts;		// 合同人员
	...
	public OaContractServicesInfo() {
		super();
	}

	public OaContractServicesInfo(String id){
		super(id);
	}
	...
	@Length(min=1, max=100, message="合同人员长度必须介于 1 和 100 之间")
