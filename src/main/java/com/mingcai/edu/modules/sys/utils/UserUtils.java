 ...
 */
package com.mingcai.edu.modules.sys.utils;
...
import com.mingcai.edu.modules.sys.dao.AreaDao;
...
public  static List<User> getByRole(String role){
	...
	public static List<User> getUsersByIds(String dis){
		if(StringUtils.isNotEmpty(dis)) {
			...
			User usera=new User();
			usera.setId(ss);
			List<User> users = userDao.getByUserIds(usera);
			return users;
		}
		return new ArrayList<User>();
	}
	public static String getUsersByIds(List<User> users){
		String name = "";
		for (User u : users) {
			name += u.getName() + ",";
		}
