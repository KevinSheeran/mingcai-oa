...
public class UserController extends BaseController {
    ...
    public String win(User user, HttpServletRequest request,Model model) {
		return "modules/sys/win";
    }
	@RequiresPermissions("sys:user:view")
	...
	public String checkMobile(String oldMobile,String mobile) {
		...
		if (mobile !=null && mobile.equals(oldMobile)) {
			return "true";
		} else if(mobile!=null&&systemService.getUserByMobile(user) == null){
			return "true";
		}
		return "false";
	}
	...
	public String updateBackGround( HttpServletRequest request,OaProductResources oaProductResources, RedirectAttributes redirectAttributes) {
		User user=UserUtils.getUser();
		user.setUserBackground(request.getParameter("bg"));
		systemService.updateUserBackground(user);
	...
	public String iconselect(HttpServletRequest request, Model model) {
		String filepath=request.getSession().getServletContext().getRealPath("/")+"/static/windowsstyle/wallpapers/bg150-85";
		...
		model.addAttribute("bgList",iconlist);
		return "modules/sys/bgList";
	}
//	@InitBinder
