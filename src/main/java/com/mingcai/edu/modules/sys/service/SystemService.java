 ...
 */
package com.mingcai.edu.modules.sys.service;
...
import com.mingcai.edu.common.security.Digests;
import com.mingcai.edu.common.security.shiro.session.SessionDAO;
import com.mingcai.edu.common.service.BaseService;
import com.mingcai.edu.common.service.ServiceException;
import com.mingcai.edu.common.utils.CacheUtils;
import com.mingcai.edu.common.utils.Encodes;
import com.mingcai.edu.common.utils.StringUtils;
import com.mingcai.edu.common.web.Servlets;
import com.mingcai.edu.modules.sys.dao.MenuDao;
...
import com.mingcai.edu.modules.sys.security.SystemAuthorizingRealm;
import com.mingcai.edu.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public List<Menu> findByType(Menu menu){
		return menuDao.findByType(menu);
	}
	/**
	 * 根据登录名获取用户
	 * @param loginName
	...
	public List<User> getByUserIds(User user){

		return userDao.getByUserIds(user);
	}
	/**
	 * 根据登录名获取用户
	 * @param user
	 ...
	 * @return
	 */
	public User getUserByWxUserId(User user) {
		return userDao.getUserByWxUserId(user);
	}
	...
	public User updateUserBackground(User user){
			userDao.updateUserBackground(user);
			// 清除用户缓存
