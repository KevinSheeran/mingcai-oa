...
public class CKFinderConfig extends Configuration {
    ...
    protected Configuration createConfigurationInstance() {
		...
		boolean isView = true;//EAUtils.getSubject().isPermitted("cms:ckfinder:view");
		boolean isUpload = true;//EAUtils.getSubject().isPermitted("cms:ckfinder:upload");
		boolean isEdit = true;//EAUtils.getSubject().isPermitted("cms:ckfinder:edit");
