            ...
            <div class="weui-form-preview" >
                ...
                <div class="weui-form-preview__bd">
                    <div class="weui-form-preview__item">
                        ...
                        <span class="weui-form-preview__value b">${item.estimation}元</span>
                    </div>
                    <div class="weui-form-preview__item">
                ...
                <div class="weui-form-preview__ft">
                    <a class="weui-form-preview__btn weui-form-preview__btn_default" href="${oa}/weixin/auditproinfo?id=${item.id}">去审批</a>
                </div>
            </div>
        </c:forEach>
    </div>
