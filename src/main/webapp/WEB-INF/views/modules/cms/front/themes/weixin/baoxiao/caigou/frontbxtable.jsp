...
<body>
    ...
    <div class="weui-form-preview"  style="display: none">
        ...
        <div class="weui-form-preview__ft">
            <button path="" onclick="delbx(this)"
                    class="weui-form-preview__btn weui-form-preview__btn_primary h">撤销申请
            </button>
            <button path="" onclick="deteils(this)"
                    class="weui-form-preview__btn weui-form-preview__btn_primary i">查看详情
            </button>
        </div>
    </div>
    </div>
    <script>
        ...
        function pullupRefresh(){
            $.get("${oa}/weixin/bx/selby",{"pageNo":pageNo,"pageSize":pageSize,"types":types},function(data){
                ...
                for(var j=0;j<fimdlist.length;j++){
                    ...
                    for (var i=0;i<item.length;i++) {
                        ...
                        if (item[i].state!="待审核"){
                            ...
                            model.find(".i").attr("path","/oa/weixin/bx/Details?idss="+item[i].id+"&type="+item[i].type+"&sh=1")
