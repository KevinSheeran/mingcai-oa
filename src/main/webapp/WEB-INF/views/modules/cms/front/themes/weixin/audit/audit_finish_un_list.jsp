...
<div id="model" style="display: none">
    <div class="weui-form-preview" >
        ...
        <div class="weui-form-preview__bd">
            ...
            <div class="weui-form-preview__item">
                <label class="weui-form-preview__label">费用估算</label>
                <span class="weui-form-preview__value d"></span>
            </div>
            <div class="weui-form-preview__item">
                <label class="weui-form-preview__label">项目负责人</label>
                <span class="weui-form-preview__value e"></span>
            </div>
            <div class="weui-form-preview__item">
                <label class="weui-form-preview__label">对接方单位</label>
                <span class="weui-form-preview__value f"></span>
            </div>
            <div class="weui-form-preview__item">
                <label class="weui-form-preview__label">对接方负责人</label>
...
<script type="text/javascript">
    ...
    function pullupRefresh(){
        $.get("${oa}/weixin/auditUnFinishListJson",{pageNo:pageNo,pageSize:pageSize},function(data){
            ...
            for(var i=0;i<fimdlist.length;i++){
                ...
                var pa="";
                if(item.proNumber==null||item.proNumber==''){
                    pa='未定义';
                }else {
                    pa = item.proNumber;
                }
                ...
                model.find(".d").html("￥"+item.estimation+"元");
                ...
                model.find(".btn").html("<button class=\"weui-form-preview__btn weui-form-preview__btn_default\" type=\"button\" onclick=\"url(this)\" path=\"${oa}/weixin/auditproinfo?id="+item.id+"\">查看详情</button>");
