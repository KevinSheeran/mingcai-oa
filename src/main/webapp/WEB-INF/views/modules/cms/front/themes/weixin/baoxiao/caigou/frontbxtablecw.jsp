...
<body>
    ...
    <script>
        ...
        function pullupRefresh(){
            $.get("${oa}/weixin/bx/selbycw",{"pageNo":pageNo,"pageSize":pageSize,"types":types},function(data){
                ...
                for(var j=0;j<fimdlist.length;j++){
                    ...
                    for (var i=0;i<item.length;i++) {
                        ...
                        model.find(".g").html(item[i].state);
                            model.find(".i").attr("path","/oa/weixin/bx/Details?idss="+item[i].id+"&type="+item[i].type+"&sh=0&success=true")
