...
<div id="content" class="row-fluid">
    ...
    <div id="right">
        <iframe id="officeContent" src="${ctx}/oa/week/oaWeekWork/Userlist" width="100%" height="91%" frameborder="0"></iframe>
    </div>
</div>
<script type="text/javascript">
    var setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"",nocheckInherit:true},
        ...
        data:{simpleData:{enable:true}},callback:{
            onClick:function(event, treeId, treeNode){
                ...
                $('#officeContent').attr("src","${ctx}/oa/week/oaWeekWork/Userlist?userId="+id);
    ...
    function refreshTree(){
        $.getJSON("${ctx}/sys/office/treeData?isAll=false&type=3",function(data){
