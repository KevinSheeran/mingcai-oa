...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/wx/oaWxUsers/">微信用户列表</a></li>
		<li class="active"><a href="${ctx}/oa/wx/oaWxUsers/form?id=${oaWxUsers.id}">微信用户<shiro:hasPermission name="oa:wx:oaWxUsers:edit">${not empty oaWxUsers.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:wx:oaWxUsers:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaWxUsers" action="${ctx}/oa/wx/oaWxUsers/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">成员所属部门id列表：</label>
			<div class="controls">
				<form:input path="department" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">部门内的排序值，默认为0。数量必须和department一致：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">是否为上级：</label>
			<div class="controls">
				<form:input path="isLeaderInDept" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="enable" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="qrCode" htmlEscape="false" maxlength="500" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">对外职务：</label>
			<div class="controls">
				<form:input path="externalPosition" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:wx:oaWxUsers:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
