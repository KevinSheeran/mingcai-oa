			...
			$(".handle").click(function(){
				...
				if(tkey=="deptLeaderAudit") {
					$.getJSON("${ctx}/oa/leave/detail/" + leaveId , function(data){
						 ...
						 $.jBox(html, { title: "流程办理["+obj.data("tname") + "]",buttons:{"同意":"yes","驳回":"no","取消":"cancel"},submit: function (v, h, f) {
							 //同意
							 if(v=="yes") {
									complete(taskId, [{
										key: 'deptLeaderPass',
							...
							//驳回
								 ...
								 $.jBox("<div style='padding:10px;'><textarea id='leaderBackReason' style='width: 250px; height: 60px;'></textarea></div>", { title: "请填写驳回理由", submit: function () {
					...
					$.getJSON("${ctx}/oa/leave/detail/" + leaveId , function(data){
						 ...
						 top.$.jBox(html, { title: "流程办理["+obj.data("tname") + "]",buttons:{"同意":"yes","驳回":"no","取消":"cancel"},submit: function (v, h, f) {
							 ...
							 //驳回
								 ...
								 $.jBox("<div style='padding:10px;'><textarea id='hrBackReason' style='width: 250px; height: 60px;'></textarea></div>", { title: "请填写驳回理由", submit: function () {
