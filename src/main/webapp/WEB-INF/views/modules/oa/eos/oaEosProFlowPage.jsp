...
<script type="application/javascript">
	...
	function goWeekPage(){
            // 正常打开
            top.top.$.jBox.open("iframe:${ctx}/oa/eos/oaEosProPresentation/page?proid=${oaEosProStart.id}", "项目周报",700,$(window).height(), {
    ...
    function goTimesPage(){
        // 正常打开
        top.$.jBox.open("iframe:${ctx}/oa/eos/oaEosProTimetotalItem/page?proid=${oaEosProStart.id}", "项目工时",700,$(window).height(), {
            buttons:{}, submit:function(v, h, f){
            }, loaded:function(h){
                $(".jbox-content", document).css("overflow-y","hidden");
            }
    ...
    function goCountPage(){
        // 正常打开
        top.$.jBox.open("iframe: ${ctx}/oa/eos/sta/getbycw?id=${oaEosProStart.id}", "统计",1000,$(window).height(), {
            buttons:{}, submit:function(v, h, f){
            }, loaded:function(h){
                $(".jbox-content", document).css("overflow-y","hidden");
            }
