...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<h4>
			<label class="control-label">企业微信用户信息:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="mobile" htmlEscape="false" maxlength="100" class="required"/><span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
	...
	function showDialog(){
        ...
        $.jBox.open("iframe:${ctx}/sys/user/win", title, width,height, {
            buttons:{"保存":"ok", "关闭":true}, submit:function(v, h, f){
                if (v=="ok"){
                    var formdata = h.find("iframe")[0].contentWindow.$("");
